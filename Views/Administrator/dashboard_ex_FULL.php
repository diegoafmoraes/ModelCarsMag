            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img
                                src="<?= BASE_URL; ?>assets/administrator/images/logo-icon.png"
                                alt="homepage"
                                class="light-logo"
                                width="25" />
                        </b>
                        ...
                        <span class="logo-text ms-2">
                            <!-- dark Logo text -->
                            <img
                                src="<?= BASE_URL; ?>assets/administrator/images/logo-text.png"
                                alt="homepage"
                                class="light-logo" />
                        </span>
                        <!-- Logo icon -->
                        ...
                        <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                        <!-- Dark Logo icon -->
                        <!-- <img src="<?= BASE_URL; ?>assets/administrator/images/logo-text.png" alt="homepage" class="light-logo" /> -->
                ...
                <div
                  ...
                  "
                                ...
                                aria-expanded="false">
                                <img
                                    src="<?= BASE_URL; ?>assets/administrator/images/users/1.jpg"
                                    alt="user"
                    ...
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a
                                class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="widgets.html"
                                aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Widgets</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a
                                class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="tables.html"
                                aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Tables</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a
                                class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="grid.html"
                                aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Full Width</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a
                        ...
                        <li class="sidebar-item">
                            <a
                                class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)"
                                aria-expanded="false"><i class="mdi mdi-move-resize-variant"></i><span class="hide-menu">Addons </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a
                                class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)"
                                aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">Authentication </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a
                                class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)"
                                aria-expanded="false"><i class="mdi mdi-alert"></i><span class="hide-menu">Errors </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img
                                            src="<?= BASE_URL; ?>assets/administrator/images/users/4.jpg"
                                            alt="user"
                                            width="50"
                                            class="rounded-circle" />
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img
                                            src="<?= BASE_URL; ?>assets/administrator/images/users/5.jpg"
                                            alt="user"
                                            width="50"
                                            class="rounded-circle" />
                                    </div>
                                            ...
                                            <ul class="list-style-none assignedto">
                                                ...
                                                <li class="assignee">
                                                    <img
                                                        class="rounded-circle"
                                                        width="40"
                                                        src="<?= BASE_URL; ?>assets/administrator/images/users/2.jpg"
                                                        alt="user"
                                                        data-toggle="tooltip"
                                                        data-placement="top"
                                                        title=""
                                                ...
                                                <li class="assignee">
                                                    <img
                                                        class="rounded-circle"
                                                        width="40"
                                                        src="<?= BASE_URL; ?>assets/administrator/images/users/3.jpg"
                                                        alt="user"
                                                        data-toggle="tooltip"
                                                        data-placement="top"
                                                        title=""
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="form-check">
                                                ...
                                                <label
                                                    ...
                                                    <span
                                                        class="badge rounded-pill bg-warning float-end">2 weeks</span>
                                                </label>
                                            </div>
                                            <div class="item-date">26 jun 2021</div>
                                        </li>
                        ...
                        <div class="card">
                            ...
                            <ul class="list-style-none">
                                ...
                                <li class="d-flex no-block card-body border-top">
                                    <i
                                        class="mdi mdi-comment-question-outline fs-4 w-30px mt-1"></i>
                                    <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height: 475px">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="<?= BASE_URL; ?>assets/administrator/images/users/1.jpg" alt="user" />
                                            </div>
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="<?= BASE_URL; ?>assets/administrator/images/users/2.jpg" alt="user" />
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="<?= BASE_URL; ?>assets/administrator/images/users/3.jpg" alt="user" />
                                            </div>
                                            <div class="chat-content">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img
                                            src="<?= BASE_URL; ?>assets/administrator/images/background/img4.jpg"
                                            class="img-fluid" />
                                    </div>
                                </div>
