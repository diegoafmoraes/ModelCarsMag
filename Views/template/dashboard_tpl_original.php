...
<head>
    ...
    <!-- ============================================================== -->
    <!-- Custom JSs -->
    <!-- jQuery first, then Popper.js, then Bootstrap JS, then other dependencies -->
...
<body>
                    ...
                    <div class="navbar-header" data-logobg="skin5">
                        ...
                        <a class="navbar-brand" href="dashboard">
                            ...
                            <b class="logo-icon ps-2">
                                ...
                                <!-- Dark Logo icon -->
                                <img
                                    src="<?= BASE_URL; ?>assets/administrator/images/model-car.png"
                                    alt="homepage"
                                    class="light-logo"
                                    width="180" />
                            </b>
                            ...
                            <span class="logo-text ms-2">
                                ...
                                <img
                                    src="<?php // BASE_URL; 
                                            ?>assets/administrator/images/logo-text.png"
                                    alt="homepage"
                                    class="light-logo" /> -->
                            </span>
                            <!-- Logo icon -->
                            ...
                            <!-- <img src="<?php // BASE_URL; 
                                            ?>assets/administrator/images/logo-text.png" alt="homepage" class="light-logo" /> -->
    ...
    <!-- Perfect ScrollBAr -->
    <script src="<?= BASE_ADM_URL; ?>libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <!-- Sparkline -->
    <script src="<?= BASE_ADM_URL; ?>extra-libs/sparkline/sparkline.js"></script>
    <!-- Wave Effects -->
    <script src="<?= BASE_ADM_URL; ?>js/waves.js"></script>
    <!-- Menu sidebar -->
    <script src="<?= BASE_ADM_URL; ?>js/sidebarmenu.js"></script>
    <!-- Custom JavaScript 
    <script src="<?// BASE_ADM_URL; ?>js/custom.min.js"></script> -->
    <!-- This page JavaScript -->
    <!-- <script src="../dist/js/pages/dashboards/dashboard1.js"></script> -->
    <!-- Charts js Files -->
    <script src="<?= BASE_ADM_URL; ?>libs/flot/excanvas.js"></script>
    <script src="<?= BASE_ADM_URL; ?>libs/flot/jquery.flot.js"></script>
    <script src="<?= BASE_ADM_URL; ?>libs/flot/jquery.flot.pie.js"></script>
    <script src="<?= BASE_ADM_URL; ?>libs/flot/jquery.flot.time.js"></script>
    <script src="<?= BASE_ADM_URL; ?>libs/flot/jquery.flot.stack.js"></script>
    <script src="<?= BASE_ADM_URL; ?>libs/flot/jquery.flot.crosshair.js"></script>
    <script src="<?= BASE_ADM_URL; ?>libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="<?= BASE_ADM_URL; ?>js/pages/chart/chart-page-init.js"></script>
